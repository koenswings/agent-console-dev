...
| `005-fine-grained-reactivity.md` | Proposed | ID-keyed `<For>` + accessor props for surgical per-row re-renders instead of full-list reconciliation on every Automerge event |
